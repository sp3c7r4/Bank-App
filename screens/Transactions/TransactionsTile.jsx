...
let type;
export default function TransactionsTile({type, amount, time, description, asset, merchant}) {
  type = type;
  return (
    <>
    <View style={{paddingHorizontal: 10, 
      ...
      <View style={{flexDirection: "row", gap: 6}}>
        <Image style={{width: 45, height: 45}} source={require('./../../assets/images/btc_gray.png')} />
