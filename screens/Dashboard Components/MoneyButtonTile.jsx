...
export default function MoneyButtonTile({
  buttonSwapMode,
  onPressTransferToBank,
  onPressTransferToMontreal,
}) {
        ...
        <View style={[styles.switchBar]}>
          <Pressable onPress={() => switchToggle("transfer")}>
            {toggle === "transfer" ? (
              ...
              <View
                style={[styles.toggleBox, { backgroundColor: "transparent" }]}
              >
                <Text style={{ fontFamily: "outfit-bold", color: "#fff" }}>
                  Transfer
                </Text>
              </View>
            )}
                ...
                <View style={{ marginTop: 30, alignItems: "center" }}>
                  ...
                  >
                    <Image
                      ...
                      source={require("./../../assets/images/to_montreal.png")}
                    />
                  </View>
                  <Text
                    style={{
